    ...
    async fetch(request, env) {
        ...
        if (实际路径 === '/check') {
            ...
            if (env.TOKEN && 已验证) {
                ...
                return await HTML(网站图标, 网络备案, img, 路径TOKEN);
            }
            ...
            if (envKey) {
                ...
                return await HTML(网站图标, 网络备案, img, null);
            }
        }
    },
};
    ...
    <div class="container">
        <div class="header">
            <div class="header-content">
                ...
                ${pathToken ? '<p style="font-size: 0.85em; opacity: 0.8;">🔒 安全模式 - 路径TOKEN验证已启用</p>' : ''}
            </div>
        ...
        <div class="footer">
            ${网络备案}
            ${pathToken ? '<p style="margin-top: 8px; opacity: 0.6;">🔒 当前会话已通过TOKEN验证</p>' : ''}
        </div>
    </div>
    ...
    <script>
        ...
        async function checkProxy() {
            ...
            try {
                ...
                if (pathToken) {
                    showToast('✅ TOKEN验证通过，代理检测完成', 3000);
                }
